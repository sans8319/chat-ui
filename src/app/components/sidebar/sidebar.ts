...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.chatService.sidebarUpdate$.subscribe(msg => {
      if (msg) {
        console.log("New Message received in Sidebar:", msg); // DEBUG
...
updateSidebarUI(msg: any) {
  ...
  if (userIndex !== -1) {
    ...
    // Agar message kisi aur ne bheja hai AUR wo user abhi active/selected nahi hai
    ...
    // Time Fix logic (Array vs String)
